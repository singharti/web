...
class Topmenu extends Template implements IdentityInterface
{
    ...
    protected function _getHtml(
        ...
        foreach ($children as $child) {
            ...
            if($divCounterLeft<2)
          {
            $html  .= '<li class="level0 nav-5 category-item last level-top ui-menu-item" role="presentation"><a href="' . $child->getUrl() . '" class="level-top ui-corner-all ui-state-focus" id="ui-id-6" tabindex="-1" role="menuitem"><span class="ui-menu-icon ui-icon ui-icon-carat-1-e">'.$child['name'].'</span></a></li>';
     }
          $divCounterLeft++;
        }

        $html .="</div><div class='logo-center'><a class='logo' href='http://127.0.0.1/m2.28/index.php/'' title=''>
    <img src='http://127.0.0.1/m2.28/pub/media/logo/default/logo.png' title='' alt='' width='100' height='200' style='width:100%'>
</a></div> 
        <div class='right'>"; 
        $divcounterRight = 0;
        foreach ($children as $child) {
        
            if($divcounterRight >= 2){
                $html .='<li class="level0 nav-5 category-item last level-top ui-menu-item" role="presentation"><a href="' . $child->getUrl() . '" class="level-top ui-corner-all ui-state-focus" id="ui-id-6" tabindex="-1" role="menuitem"><span class="ui-menu-icon ui-icon ui-icon-carat-1-e">';
                $html .= $child['name'].'</span></a></li>';
